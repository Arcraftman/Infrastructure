...
// Core operations
STK_API STK_STATUS stk_list_init(stk_list* l);
STK_API STK_STATUS stk_list_free(stk_list* l);
STK_API STK_STATUS stk_list_push_front(stk_list* l, void* val);
