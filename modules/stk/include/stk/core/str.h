...
STK_API void stk_str_init(stk_str* s);
STK_API void stk_str_init_from(stk_str* s, const char* cstr);
STK_API void stk_str_free(stk_str* s);
...
STK_API void stk_str_clear(stk_str* s);
STK_API void stk_str_push(stk_str* s, char ch);
STK_API void stk_str_pop(stk_str* s);
STK_API void stk_str_append(stk_str* s, const char* cstr);
STK_API void stk_str_append_str(stk_str* s, const stk_str* other);
STK_API void stk_str_assign(stk_str* s, const char* cstr);
STK_API void stk_str_assign_str(stk_str* s, const stk_str* other);
...
STK_API void stk_str_to_upper(stk_str* s);
STK_API void stk_str_to_lower(stk_str* s);
...
STK_API void stk_str_copy(stk_str* dest, const stk_str* src);
