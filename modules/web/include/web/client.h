 ...
 */
WEB_API web_response_t* web_client_request(web_client_t* client,
                                           const char* method,
                                           const char* url,
 ...
 */
WEB_API int web_client_set_proxy(web_client_t* client, const char* proxy_url);

/**
 * Destroy the HTTP client.
 */
WEB_API void web_client_destroy(web_client_t* client);
